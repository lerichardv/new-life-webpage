...
import { Plus_Jakarta_Sans, Inter, Bodoni_Moda } from "next/font/google";
...
export default function RootLayout({
	...
	return (
		<html
			lang="en"
			className={`${plusJakartaSans.variable} ${inter.variable} ${bodoniModa.variable} h-full antialiased`}
		>
